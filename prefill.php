...
$fields = [
    'author_name' =>            ['Your name',             '',                                                'Oitmain, Inc'],
    'author_github_username' => ['Your Github username',  '<username> in https://github.com/username',       'oitmain'],
    'author_email' =>           ['Your email address',    '',                                                'support@oitmain.com'],
    'author_twitter' =>         ['Your twitter username', '',                                                '@{author_github_username}'],
    'author_website' =>         ['Your website',          '',                                                'http://oitmain.com'],
...
$replacements = [
    ...
    'Oitmain\\Skeleton'             => function () use(&$values) { return $values['psr4_namespace']; },
];
